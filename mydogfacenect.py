...
PATH = './data/pictures/somedoghead/'  # Path to the directory of the saved dataset
...
NET_NAME = './data/model/model'   # Network saved name
...
if HIGH_LEVEL:
    ...
    crt_acc = 0
    batch_size = 3*10
    nbof_subclasses = TEST_SPLIT*nbof_classes
    ...
    #     print("this thing is keep working----------------------------")
